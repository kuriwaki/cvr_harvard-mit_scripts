#####################################################
#        Clean all the CVR data for West Virginia   #
...
def nicholas_cleaner(df):
    ...
    districts = {
        ...
        "for u.s. house of representatives 3rd dist (2082)" : "003",
        "for governor (2087)" : "WEST VIRGINIA", 
        "for secretary of state (2092)" : "WEST VIRGINIA",
        "for auditor (2097)" : "WEST VIRGINIA", 
        "for treasurer (2102)" : "WEST VIRGINIA",
        "for commissioner of agriculture (2107)" : "WEST VIRGINIA", 
        "for attorney general (2112)" : "WEST VIRGINIA",
        "for state senator 11th dist (2117)" : "011",
        "for member of house of delegates 32nd delegate district (2122)" : "032",
        "for member of house of delegates 41st delegate district (2131)" : "041",
        "for member of house of delegates 44th delegate district (2136)" : "044",
        "nonpartisan ballot of election of family court judge - 16th div" : "16",
        "for county commissioner (2141)" : "NICHOLAS", 
        "for prosecuting attorney (2146)" : "NICHOLAS",
        "for sheriff (2151)" : "NICHOLAS", 
        "for assessor (2156)" : "NICHOLAS", 
        "for surveyor (2161)" : "NICHOLAS",
    }
...
def wood_cleaner(df):
    ...
    districts = {
        ...
        "for auditor (3517)" : "WEST VIRGINIA", 
        "for treasurer (3522)" : "WEST VIRGINIA",
        "for commissioner of agriculture (3527)" : "WEST VIRGINIA", 
        "for attorney general (3532)" : "WEST VIRGINIA",
        ...
        "for circuit clerk - unexpired term (3561)" : "WOOD",
        "for county commissioner dist c (3566)" : "WOOD C",
        "for prosecuting attorney (3571)" : "WOOD", 
        "for sheriff (3576)" : "WOOD",
        "for assessor (3581)" : "WOOD", 
        "for surveyor (3586)" : "WOOD",
        ...
        "for council-at-large city of vienna (3606)" : "VIENNA", 
